...
static_assert(Helper{hyperliquid::json::EventType{hyperliquid::json::EventType::UNDEFINED__}} == roq::UpdateType::UNDEFINED);
...
static_assert(Helper{hyperliquid::json::OptionsType{hyperliquid::json::OptionsType::UNDEFINED__}} == roq::OptionType::UNDEFINED);
...
static_assert(Helper{hyperliquid::json::OrderStatus{hyperliquid::json::OrderStatus::UNDEFINED__}} == roq::OrderStatus::UNDEFINED);
...
static_assert(Helper{hyperliquid::json::OrderType{hyperliquid::json::OrderType::UNDEFINED__}} == roq::OrderType::UNDEFINED);
...
static_assert(Helper{hyperliquid::json::Side{hyperliquid::json::Side::UNDEFINED__}} == roq::Side::UNDEFINED);
...
static_assert(Helper{hyperliquid::json::Status{hyperliquid::json::Status::UNDEFINED__}} == roq::TradingStatus::UNDEFINED);
...
static_assert(Helper{hyperliquid::json::TimeInForce{hyperliquid::json::TimeInForce::UNDEFINED__}} == roq::TimeInForce::UNDEFINED);
...
static_assert(
    Helper{hyperliquid::json::ContractType{hyperliquid::json::ContractType::UNDEFINED__}, hyperliquid::json::OptionsType{hyperliquid::json::OptionsType::UNDEFINED__}} ==
    roq::SecurityType::SPOT);
static_assert(
    Helper{hyperliquid::json::ContractType{hyperliquid::json::ContractType::UNDEFINED__}, hyperliquid::json::OptionsType{hyperliquid::json::OptionsType::CALL}} ==
    roq::SecurityType::OPTION);
static_assert(
    Helper{hyperliquid::json::ContractType{hyperliquid::json::ContractType::UNDEFINED__}, hyperliquid::json::OptionsType{hyperliquid::json::OptionsType::PUT}} ==
    roq::SecurityType::OPTION);
static_assert(
    Helper{hyperliquid::json::ContractType{hyperliquid::json::ContractType::INVERSE_PERPETUAL}, hyperliquid::json::OptionsType{hyperliquid::json::OptionsType::UNDEFINED__}} ==
    roq::SecurityType::SWAP);
static_assert(
    Helper{hyperliquid::json::ContractType{hyperliquid::json::ContractType::LINEAR_PERPETUAL}, hyperliquid::json::OptionsType{hyperliquid::json::OptionsType::UNDEFINED__}} ==
    roq::SecurityType::SWAP);
static_assert(
    Helper{hyperliquid::json::ContractType{hyperliquid::json::ContractType::LINEAR_FUTURES}, hyperliquid::json::OptionsType{hyperliquid::json::OptionsType::UNDEFINED__}} ==
    roq::SecurityType::FUTURES);
static_assert(
    Helper{hyperliquid::json::ContractType{hyperliquid::json::ContractType::INVERSE_FUTURES}, hyperliquid::json::OptionsType{hyperliquid::json::OptionsType::UNDEFINED__}} ==
    roq::SecurityType::FUTURES);
...
constexpr Helper<roq::OrderType>::operator std::optional<hyperliquid::json::OrderType>() const {
  switch (std::get<0>(args_)) {
    ...
    case UNDEFINED:
      return hyperliquid::json::OrderType::UNDEFINED__;
    case MARKET:
...
static_assert(Helper{roq::OrderType::UNDEFINED} == hyperliquid::json::OrderType{hyperliquid::json::OrderType::UNDEFINED__});
...
constexpr Helper<roq::Side>::operator std::optional<hyperliquid::json::Side>() const {
  switch (std::get<0>(args_)) {
    using enum roq::Side;
    case UNDEFINED:
      return hyperliquid::json::Side::UNDEFINED__;
    case BUY:
...
static_assert(Helper{roq::Side::UNDEFINED} == hyperliquid::json::Side{hyperliquid::json::Side::UNDEFINED__});
...
constexpr Helper<roq::TimeInForce>::operator std::optional<hyperliquid::json::TimeInForce>() const {
  switch (std::get<0>(args_)) {
    ...
    case UNDEFINED:
      return hyperliquid::json::TimeInForce::UNDEFINED__;
    case GFD:
      return hyperliquid::json::TimeInForce::UNDEFINED__;
    case GTC:
...
static_assert(Helper{roq::TimeInForce::UNDEFINED} == hyperliquid::json::TimeInForce{hyperliquid::json::TimeInForce::UNDEFINED__});
