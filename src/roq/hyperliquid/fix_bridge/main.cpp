...
#include "roq/hyperliquid/fix_bridge/application.hpp"
...
auto const INFO = roq::Service::Info{
    .description = "Roq's Hyperliquid gateway (FIX interface)"sv,
...
int main(int argc, char **argv) {
  ...
  return roq::hyperliquid::fix_bridge::Application{args, settings, INFO}.run();
}
